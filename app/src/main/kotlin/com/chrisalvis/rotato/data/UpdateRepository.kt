...
object UpdateRepository {
    private const val RELEASES_URL =
        "https://api.github.com/repos/Alvis1337/rotato/releases/latest"
    ...
    suspend fun checkForUpdate(): UpdateCheckResult = withContext(Dispatchers.IO) {
        try {
            ...
            val tagName = json.optString("tag_name", "")   // e.g. "v1.0.47"
            val releaseNotes = json.optString("body", "").trim()

            // Extract versionCode from tag: last numeric segment after the last dot
    ...
    suspend fun downloadAndInstall(
        ...
        try {
            val destFile = File(context.getExternalFilesDir(null), "rotato-update.apk")
